...
class ModifySaleWidget extends StatefulWidget {
  const ModifySaleWidget({
    Key key,
    this.saleDetails,
  }) : super(key: key);
  ...
  @override
  _ModifySaleWidgetState createState() => _ModifySaleWidgetState();
}

class _ModifySaleWidgetState extends State<ModifySaleWidget>
          ...
          builder: (context, snapshot) {
            ...
            return Column(
              ...
              children: [
                ...
                if (!(columnSalesRecord.processed) ?? true)
                  Padding(
