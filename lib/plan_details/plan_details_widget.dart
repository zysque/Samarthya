  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ProjectsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final planDetailsProjectsRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                          ...
                          stream: queryPlansAndRatesRecord(
                            queryBuilder: (plansAndRatesRecord) =>
                                plansAndRatesRecord
                                    .where('projectRef',
                                        isEqualTo:
                                            planDetailsProjectsRecord.reference)
                                    .orderBy('phaseCode'),
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            ...
                            List<PlansAndRatesRecord>
                                listViewPlansAndRatesRecordList = snapshot.data;
                            ...
                            return ListView.builder(
                              ...
                              itemCount: listViewPlansAndRatesRecordList.length,
                                    ...
                                    onTap: () async {
                                      await Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              CreateBookingWidget(
                                            planRef: listViewPlansAndRatesRecord
                                                .reference,
                                          ),
                                        ),
                                      );
