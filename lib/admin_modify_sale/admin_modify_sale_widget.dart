...
class AdminModifySaleWidget extends StatefulWidget {
  const AdminModifySaleWidget({
    Key key,
    this.saleDetails,
  }) : super(key: key);
  ...
  @override
  _AdminModifySaleWidgetState createState() => _AdminModifySaleWidgetState();
}

class _AdminModifySaleWidgetState extends State<AdminModifySaleWidget>
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<SalesRecord>(
          ...
          builder: (context, snapshot) {
            ...
            final columnSalesRecord = snapshot.data;
            return Column(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                controller: textController1 ??=
                                  ...
                                  text: columnSalesRecord.saleAmount.toString(),
                                ),
                                obscureText: false,
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      final calculationListUpdateData =
                                        ...
                                        unProcessedAmount: functions.getDiff(
                                            buttonCalculationListRecord
                                                .unProcessedAmount,
                                            columnSalesRecord.saleAmount),
                                        directCommissionAmount:
                                            functions.getSum(
                                                buttonCalculationListRecord
                                                    .directCommissionAmount,
                                                functions.getCommission(
                                                    rowAdminConstsRecord
                                                        .directPer,
                                                    int.parse(
                                      ...
                                      await buttonCalculationListRecord
                                          .reference
