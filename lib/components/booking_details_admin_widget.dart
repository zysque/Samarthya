...
class BookingDetailsAdminWidget extends StatefulWidget {
  const BookingDetailsAdminWidget({
    Key key,
    this.bookingDetails,
  }) : super(key: key);
  ...
  @override
  _BookingDetailsAdminWidgetState createState() =>
      _BookingDetailsAdminWidgetState();
}

class _BookingDetailsAdminWidgetState extends State<BookingDetailsAdminWidget> {
