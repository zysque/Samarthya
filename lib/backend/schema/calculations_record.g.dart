    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'userCode':
          ...
          break;
        case 'unPBusinessAmt':
          result.unPBusinessAmt = serializers.deserialize(value,
              specifiedType: const FullType(double)) as double;
          break;
...
class _$CalculationsRecord extends CalculationsRecord {
  ...
  bool operator ==(Object other) {
    ...
    return other is CalculationsRecord &&
        ...
        unPBusinessAmt == other.unPBusinessAmt &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper('CalculationsRecord')
          ...
          ..add('unPBusinessAmt', unPBusinessAmt)
...
class CalculationsRecordBuilder
  ...
  double _unPBusinessAmt;
  double get unPBusinessAmt => _$this._unPBusinessAmt;
  set unPBusinessAmt(double unPBusinessAmt) =>
      _$this._unPBusinessAmt = unPBusinessAmt;
  ...
  CalculationsRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _unPBusinessAmt = $v.unPBusinessAmt;
